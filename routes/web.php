...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/products/fiscal-categories', [FiscalCategoryController::class, 'index'])->name('products.fiscal-categories.index');
    Route::post('/products/fiscal-categories', [FiscalCategoryController::class, 'store'])->name('products.fiscal-categories.store');
    Route::put('/products/fiscal-categories/{categoriaFiscal}', [FiscalCategoryController::class, 'update'])->name('products.fiscal-categories.update');
    Route::delete('/products/fiscal-categories/{categoriaFiscal}', [FiscalCategoryController::class, 'destroy'])->name('products.fiscal-categories.destroy');
    Route::get('/products/grupos-ncm', [GrupoNcmController::class, 'index'])->name('products.grupos-ncm.index');
    Route::post('/products/grupos-ncm', [GrupoNcmController::class, 'store'])->name('products.grupos-ncm.store');
    Route::put('/products/grupos-ncm/{grupoNcm}', [GrupoNcmController::class, 'update'])->name('products.grupos-ncm.update');
    Route::delete('/products/grupos-ncm/{grupoNcm}', [GrupoNcmController::class, 'destroy'])->name('products.grupos-ncm.destroy');
    Route::get('/products/fiscal-mass-association', [ProductFiscalMassAssociationController::class, 'index'])->name('products.fiscal-mass-association.index');
    Route::post('/products/fiscal-mass-association', [ProductFiscalMassAssociationController::class, 'apply'])->name('products.fiscal-mass-association.apply');
    Route::patch('/products/fiscal-mass-association/{product}/name', [ProductFiscalMassAssociationController::class, 'renameProduct'])->name('products.fiscal-mass-association.rename-product');
    ...
    Route::post('/reports/cash-closure/close', [SalesReportController::class, 'closeCashClosure'])->name('reports.cash.closure.close');
